...
> Sinh tự động bằng `npm run sql:audit` lúc 2026-09-02T01:50:06.051Z.
...
|---|---|
| Route đã bắn | 54 |
| Câu SQL chạy thật | 198 |
| Câu SQL khác nhau | 114 |
...
| order_items | 1.968 | | addresses | 80 |
| products | 1.955 | | users | 63 |
| notifications | 1.575 | | wallets | 50 |
| orders | 1.003 | | shops | 15 |
| wallet_transactions | 1.000 | | ledger_entries | 9 |
| reviews | 600 | | categories | 9 |
| payments | 600 | | ledger_accounts | 5 |
| order_shipments | 500 | | ledger_transactions | 4 |
| follows | 336 | | escrows | 2 |
| withdrawals | 315 | | settings | 1 |
...
|---|---|---|---|---:|
| CAO | `src/catalog/sitemap/sitemap.service.ts:65` | quét toàn bảng 2011 dòng, không dùng index | `ALL` · key=`∅` · rows=2011 | 5.37 |
| CAO | `src/catalog/products/products.service.ts:302` | TypeORM dựng bảng dẫn xuất rồi DISTINCT trên 2011 dòng; sắp xếp ngoài index (filesort); phải dựng bảng tạm | `ALL` · key=`∅` · rows=2011 | 2.67 |
| CAO | `src/catalog/shop/shop.service.ts:110` | TypeORM dựng bảng dẫn xuất rồi DISTINCT trên 2011 dòng | `ALL` · key=`∅` · rows=2011 | 2.59 |
| CAO | `src/ops/admin/admin.service.ts:137` | quét toàn bảng 1003 dòng, không dùng index | `ALL` · key=`∅` · rows=1003 | 1.07 |
| CAO | `src/ordering/orders/orders.service.ts:80` | quét toàn bảng 1003 dòng, không dùng index | `ALL` · key=`∅` · rows=1003 | 0.91 |
| VỪA | `src/catalog/shop/shop.service.ts:140` | đếm cả bảng 2011 dòng cho phân trang | `ALL` · key=`∅` · rows=2011 | 6.06 |
| VỪA | `src/catalog/shop/shop.service.ts:110` | đếm cả bảng 2011 dòng cho phân trang | `ALL` · key=`∅` · rows=2011 | 1.88 |
| VỪA | `src/catalog/products/products.service.ts:302` | đếm cả bảng 2011 dòng cho phân trang | `ALL` · key=`∅` · rows=2011 | 1.72 |
| VỪA | `src/catalog/interactions/interactions.service.ts:104` | TypeORM dựng bảng dẫn xuất rồi DISTINCT trên 600 dòng; sắp xếp ngoài index (filesort); phải dựng bảng tạm | `ALL` · key=`∅` · rows=600 | 1.66 |
| VỪA | `src/catalog/shop/shop.service.ts:100` | đếm cả bảng 2011 dòng cho phân trang | `ALL` · key=`∅` · rows=2011 | 1.65 |
| VỪA | `src/ops/admin/admin.service.ts:71` | đếm cả bảng 2011 dòng cho phân trang | `ALL` · key=`∅` · rows=2011 | 1.31 |
| VỪA | `src/catalog/interactions/interactions.service.ts:104` | đếm cả bảng 600 dòng cho phân trang | `ALL` · key=`∅` · rows=600 | 1.25 |
| VỪA | `src/ordering/orders/orders.service.ts:73` | đếm cả bảng 2011 dòng cho phân trang | `ALL` · key=`∅` · rows=2011 | 1.02 |
| VỪA | `src/ordering/orders/orders.service.ts:323` | đếm cả bảng 1003 dòng cho phân trang | `ALL` · key=`∅` · rows=1003 | 1.01 |
| VỪA | `src/ops/admin/admin.service.ts:180` | TypeORM dựng bảng dẫn xuất rồi DISTINCT trên 315 dòng; sắp xếp ngoài index (filesort); phải dựng bảng tạm | `ALL` · key=`∅` · rows=315 | 1.01 |
| VỪA | `src/ops/admin/admin.service.ts:131` | đếm cả bảng 2011 dòng cho phân trang | `ALL` · key=`∅` · rows=2011 | 1 |
| VỪA | `src/ops/admin/admin.service.ts:140` | đếm cả bảng 1003 dòng cho phân trang | `ALL` · key=`∅` · rows=1003 | 0.82 |
| VỪA | `src/ordering/orders/orders.service.ts:74` | đếm cả bảng 1003 dòng cho phân trang | `ALL` · key=`∅` · rows=1003 | 0.73 |
| VỪA | `src/ops/admin/admin.service.ts:180` | đếm cả bảng 315 dòng cho phân trang | `ALL` · key=`∅` · rows=315 | 0.73 |
| VỪA | `src/ops/admin/admin.service.ts:132` | đếm cả bảng 1003 dòng cho phân trang | `ALL` · key=`∅` · rows=1003 | 0.7 |
| THẤP | `src/messaging/chat/chat.service.ts:106` | sắp xếp ngoài index (filesort); phải dựng bảng tạm | `ALL` · key=`∅` · rows=120 | 1.09 |
| THẤP | `src/messaging/chat/chat.service.ts:182` | sắp xếp ngoài index (filesort) | `range` · key=`idx_conversation_created` · rows=90 | 0.97 |
| THẤP | `src/ops/admin/admin.service.ts:47` | sắp xếp ngoài index (filesort) | `ALL` · key=`∅` · rows=63 | 0.83 |
...
<details><summary><b>dòng 58</b> — <code>QueryBuilder.getRawMany</code> <i>(1 lượt, 2.1ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=idx_category_id` · `rows=223` · `Using where` · chạy thật **2.1ms**

Route gọi tới: `GET /api/v1/categories [buyer]`

</details>

<details><summary><b>dòng 60</b> — <code>Repository.count</code> <i>(1 lượt, 0.61ms)</i></summary>

```sql
SELECT COUNT(1) AS `cnt` FROM `categories` `Category` WHERE `Category`.`deleted_at` IS NULL
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=9` · `Using where` · chạy thật **0.61ms**

Route gọi tới: `GET /api/v1/categories [buyer]`

</details>

<details><summary><b>dòng 87</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.64ms)</i></summary>
...
EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **0.64ms**

Route gọi tới: `GET /api/v1/categories/{id} [buyer]`

</details>

<details><summary><b>dòng 95</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.7ms)</i></summary>
...
EXPLAIN: `type=const` · `key=IDX_420d9f679d41281f282f5bc7d0` · `rows=1` · chạy thật **0.7ms**
...
<details><summary><b>dòng 32</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.66ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=1` · `Using filesort` · chạy thật **0.66ms**

Route gọi tới: `GET /api/v1/files [buyer]`

</details>

<details><summary><b>dòng 46</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.7ms)</i></summary>
...
EXPLAIN: `type=?` · `key=∅` · `rows=0` · `no matching row in const table` · chạy thật **0.7ms**
...
<details><summary><b>dòng 36</b> — <code>Repository.count</code> <i>(1 lượt, 0.75ms)</i></summary>

```sql
SELECT COUNT(1) AS `cnt` FROM `follows` `Follow` WHERE ((`Follow`.`follower_id` = ?) AND (`Follow`.`following_id` = ?))
```

EXPLAIN: `type=?` · `key=∅` · `rows=0` · `no matching row in const table` · chạy thật **0.75ms**

Route gọi tới: `GET /api/v1/follows/check/{sellerId} [buyer]`

</details>

<details><summary><b>dòng 44</b> — <code>Repository.count</code> <i>(1 lượt, 0.65ms)</i></summary>

```sql
SELECT COUNT(1) AS `cnt` FROM `follows` `Follow` WHERE ((`Follow`.`following_id` = ?))
```

EXPLAIN: `type=ref` · `key=FK_c518e3988b9c057920afaf2d8c0` · `rows=16` · `Using index` · chạy thật **0.65ms**

Route gọi tới: `GET /api/v1/follows/{userId}/count [buyer]`

</details>

<details><summary><b>dòng 50</b> — <code>Repository.count</code> <i>(1 lượt, 0.63ms)</i></summary>

```sql
SELECT COUNT(1) AS `cnt` FROM `follows` `Follow` WHERE ((`Follow`.`follower_id` = ?))
```

EXPLAIN: `type=ref` · `key=IDX_8109e59f691f0444b43420f698` · `rows=1` · `Using index` · chạy thật **0.63ms**

Route gọi tới: `GET /api/v1/follows/{userId}/count [buyer]`

</details>

<details><summary><b>dòng 56</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.96ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=FK_c518e3988b9c057920afaf2d8c0` · `rows=16` · `Using temporary; Using filesort` · chạy thật **0.96ms**

Route gọi tới: `GET /api/v1/follows/{userId}/followers [buyer]`

</details>

<details><summary><b>dòng 56</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.91ms)</i></summary>
...
EXPLAIN: `type=range` · `key=PRIMARY` · `rows=16` · `Using where; Using filesort` · chạy thật **0.91ms**

Route gọi tới: `GET /api/v1/follows/{userId}/followers [buyer]`

</details>

<details><summary><b>dòng 76</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.93ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=IDX_8109e59f691f0444b43420f698` · `rows=1` · `Using temporary; Using filesort` · chạy thật **0.93ms**
...
<details><summary><b>dòng 69</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.78ms)</i></summary>
...
EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · `Using temporary; Using filesort` · chạy thật **0.78ms**

Route gọi tới: `GET /api/v1/interactions/product/{productId} [buyer]`

</details>

<details><summary><b>dòng 69</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.82ms)</i></summary>
...
EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **0.82ms**

Route gọi tới: `GET /api/v1/interactions/product/{productId} [buyer]`

</details>

<details><summary><b>dòng 81</b> — <code>QueryBuilder.getRawOne</code> <i>(1 lượt, 0.83ms)</i></summary>

```sql
SELECT AVG(`review`.`rating`) AS `avg` FROM `reviews` `review` WHERE ( `review`.`product_id` = ? ) AND ( `review`.`deleted_at` IS NULL )
```

EXPLAIN: `type=ref` · `key=idx_product_created` · `rows=1` · `Using where` · chạy thật **0.83ms**

Route gọi tới: `GET /api/v1/interactions/product/{productId} [buyer]`

</details>

<details><summary><b>dòng 104</b> — <code>Repository.findAndCount</code> — <b>[VỪA]</b> TypeORM dựng bảng dẫn xuất rồi DISTINCT trên 600 dòng; sắp xếp ngoài index (filesort); phải dựng bảng tạm <i>(1 lượt, 1.66ms)</i></summary>

```sql
SELECT DISTINCT `distinctAlias`.`Review_id` AS `ids_Review_id`, `distinctAlias`.`Review_created_at` FROM (SELECT `Review`.`id` AS `Review_id`, `Review`.`rating` AS `Review_rating`, `Review`.`comment` AS `Review_comment`, `Review`.`images` AS `Review_images`, `Review`.`created_at` AS `Review_created_at`, `Review`.`updated_at` AS `Review_updated_at`, `Review`.`user_id` AS `Review_user_id`, `Review`.`product_id` AS `Review_product_id`, `Review`.`order_id` AS `Review_order_id`, `Review__Review_user`.`id` AS `Review__Review_user_id`, `Review__Review_user`.`full_name` AS `Review__Review_user_full_name`, `Review__Review_user`.`email` AS `Review__Review_user_email`, `Review__Review_user`.`phone_number` AS `Review__Review_user_phone_number`, `Review__Review_user`.`role` AS `Review__Review_user_role`, `Review__Review_user`.`avatar` AS `Review__Review_user_avatar`, `Review__Review_user`.`email_veri …(cắt bớt)
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=600` · `Using where; Using temporary; Using filesort` · chạy thật **1.66ms**

Route gọi tới: `GET /api/v1/interactions [buyer]`

</details>

<details><summary><b>dòng 104</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 1.39ms)</i></summary>

```sql
SELECT `Review`.`id` AS `Review_id`, `Review`.`rating` AS `Review_rating`, `Review`.`comment` AS `Review_comment`, `Review`.`images` AS `Review_images`, `Review`.`created_at` AS `Review_created_at`, `Review`.`updated_at` AS `Review_updated_at`, `Review`.`user_id` AS `Review_user_id`, `Review`.`product_id` AS `Review_product_id`, `Review`.`order_id` AS `Review_order_id`, `Review__Review_user`.`id` AS `Review__Review_user_id`, `Review__Review_user`.`full_name` AS `Review__Review_user_full_name`, `Review__Review_user`.`email` AS `Review__Review_user_email`, `Review__Review_user`.`phone_number` AS `Review__Review_user_phone_number`, `Review__Review_user`.`role` AS `Review__Review_user_role`, `Review__Review_user`.`avatar` AS `Review__Review_user_avatar`, `Review__Review_user`.`email_verified` AS `Review__Review_user_email_verified`, `Review__Review_user`.`is_locked` AS `Review__Review_user_i …(cắt bớt)
```

EXPLAIN: `type=range` · `key=PRIMARY` · `rows=10` · `Using where; Using filesort` · chạy thật **1.39ms**

Route gọi tới: `GET /api/v1/interactions [buyer]`

</details>

<details><summary><b>dòng 104</b> — <code>Repository.findAndCount</code> — <b>[VỪA]</b> đếm cả bảng 600 dòng cho phân trang <i>(1 lượt, 1.25ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=600` · `Using where` · chạy thật **1.25ms**

Route gọi tới: `GET /api/v1/interactions [buyer]`

</details>

<details><summary><b>dòng 125</b> — <code>Repository.findOne</code> <i>(1 lượt, 1.06ms)</i></summary>
...
EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **1.06ms**

Route gọi tới: `GET /api/v1/interactions/{id} [buyer]`

</details>

<details><summary><b>dòng 125</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.88ms)</i></summary>

```sql
SELECT `Review`.`id` AS `Review_id`, `Review`.`rating` AS `Review_rating`, `Review`.`comment` AS `Review_comment`, `Review`.`images` AS `Review_images`, `Review`.`created_at` AS `Review_created_at`, `Review`.`updated_at` AS `Review_updated_at`, `Review`.`user_id` AS `Review_user_id`, `Review`.`product_id` AS `Review_product_id`, `Review`.`order_id` AS `Review_order_id`, `Review__Review_user`.`id` AS `Review__Review_user_id`, `Review__Review_user`.`full_name` AS `Review__Review_user_full_name`, `Review__Review_user`.`email` AS `Review__Review_user_email`, `Review__Review_user`.`phone_number` AS `Review__Review_user_phone_number`, `Review__Review_user`.`role` AS `Review__Review_user_role`, `Review__Review_user`.`avatar` AS `Review__Review_user_avatar`, `Review__Review_user`.`email_verified` AS `Review__Review_user_email_verified`, `Review__Review_user`.`is_locked` AS `Review__Review_user_i …(cắt bớt)
```

EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **0.88ms**
...
<details><summary><b>dòng 302</b> — <code>Repository.findAndCount</code> — <b>[CAO]</b> TypeORM dựng bảng dẫn xuất rồi DISTINCT trên 2011 dòng; sắp xếp ngoài index (filesort); phải dựng bảng tạm <i>(1 lượt, 2.67ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=2011` · `Using where; Using temporary; Using filesort` · chạy thật **2.67ms**

Route gọi tới: `GET /api/v1/products [buyer]`

</details>

<details><summary><b>dòng 302</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 1.02ms)</i></summary>
...
EXPLAIN: `type=range` · `key=PRIMARY` · `rows=10` · `Using where; Using filesort` · chạy thật **1.02ms**

Route gọi tới: `GET /api/v1/products [buyer]`

</details>

<details><summary><b>dòng 302</b> — <code>Repository.findAndCount</code> — <b>[VỪA]</b> đếm cả bảng 2011 dòng cho phân trang <i>(1 lượt, 1.72ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=2011` · `Using where` · chạy thật **1.72ms**

Route gọi tới: `GET /api/v1/products [buyer]`

</details>

<details><summary><b>dòng 345</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.86ms)</i></summary>
...
EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **0.86ms**

Route gọi tới: `GET /api/v1/products/{id} [buyer]`

</details>

<details><summary><b>dòng 345</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.92ms)</i></summary>

```sql
SELECT `Product`.`id` AS `Product_id`, `Product`.`name` AS `Product_name`, `Product`.`slug` AS `Product_slug`, `Product`.`description` AS `Product_description`, `Product`.`price` AS `Product_price`, `Product`.`currency` AS `Product_currency`, `Product`.`stock` AS `Product_stock`, `Product`.`image` AS `Product_image`, `Product`.`brand` AS `Product_brand`, `Product`.`spec` AS `Product_spec`, `Product`.`images` AS `Product_images`, `Product`.`condition` AS `Product_condition`, `Product`.`is_freeship` AS `Product_is_freeship`, `Product`.`sold_count` AS `Product_sold_count`, `Product`.`view_count` AS `Product_view_count`, `Product`.`status` AS `Product_status`, `Product`.`created_at` AS `Product_created_at`, `Product`.`updated_at` AS `Product_updated_at`, `Product`.`category_id` AS `Product_category_id`, `Product`.`seller_id` AS `Product_seller_id`, `Product__Product_category`.`id` AS `Produc …(cắt bớt)
```

EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **0.92ms**
...
<details><summary><b>dòng 58</b> — <code>Repository.findOne</code> <i>(2 lượt, 0.71ms)</i></summary>
...
EXPLAIN: `type=?` · `key=∅` · `rows=0` · `no matching row in const table` · chạy thật **0.71ms**

Route gọi tới: `GET /api/v1/shop/me [buyer]`, `GET /api/v1/shop/me [seller]`

</details>

<details><summary><b>dòng 58</b> — <code>Repository.findOne</code> <i>(1 lượt, 1.01ms)</i></summary>
...
EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **1.01ms**

Route gọi tới: `GET /api/v1/shop/me [seller]`

</details>

<details><summary><b>dòng 85</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.83ms)</i></summary>

```sql
SELECT DISTINCT `distinctAlias`.`Shop_id` AS `ids_Shop_id` FROM (SELECT `Shop`.`id` AS `Shop_id`, `Shop`.`name` AS `Shop_name`, `Shop`.`slug` AS `Shop_slug`, `Shop`.`description` AS `Shop_description`, `Shop`.`logo` AS `Shop_logo`, `Shop`.`banner` AS `Shop_banner`, `Shop`.`phone` AS `Shop_phone`, `Shop`.`address` AS `Shop_address`, `Shop`.`pickup_name` AS `Shop_pickup_name`, `Shop`.`pickup_phone` AS `Shop_pickup_phone`, `Shop`.`pickup_address` AS `Shop_pickup_address`, `Shop`.`pickup_province_name` AS `Shop_pickup_province_name`, `Shop`.`pickup_district_id` AS `Shop_pickup_district_id`, `Shop`.`pickup_district_name` AS `Shop_pickup_district_name`, `Shop`.`pickup_ward_code` AS `Shop_pickup_ward_code`, `Shop`.`pickup_ward_name` AS `Shop_pickup_ward_name`, `Shop`.`status` AS `Shop_status`, `Shop`.`created_at` AS `Shop_created_at`, `Shop`.`updated_at` AS `Shop_updated_at`, `Shop`.`user_id` A …(cắt bớt)
```

EXPLAIN: `type=const` · `key=REL_bb9c758dcc60137e56f6fee72f` · `rows=1` · `Using index` · chạy thật **0.83ms**

Route gọi tới: `GET /api/v1/shop/{sellerId} [buyer]`

</details>

<details><summary><b>dòng 85</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.9ms)</i></summary>

```sql
SELECT `Shop`.`id` AS `Shop_id`, `Shop`.`name` AS `Shop_name`, `Shop`.`slug` AS `Shop_slug`, `Shop`.`description` AS `Shop_description`, `Shop`.`logo` AS `Shop_logo`, `Shop`.`banner` AS `Shop_banner`, `Shop`.`phone` AS `Shop_phone`, `Shop`.`address` AS `Shop_address`, `Shop`.`pickup_name` AS `Shop_pickup_name`, `Shop`.`pickup_phone` AS `Shop_pickup_phone`, `Shop`.`pickup_address` AS `Shop_pickup_address`, `Shop`.`pickup_province_name` AS `Shop_pickup_province_name`, `Shop`.`pickup_district_id` AS `Shop_pickup_district_id`, `Shop`.`pickup_district_name` AS `Shop_pickup_district_name`, `Shop`.`pickup_ward_code` AS `Shop_pickup_ward_code`, `Shop`.`pickup_ward_name` AS `Shop_pickup_ward_name`, `Shop`.`status` AS `Shop_status`, `Shop`.`created_at` AS `Shop_created_at`, `Shop`.`updated_at` AS `Shop_updated_at`, `Shop`.`user_id` AS `Shop_user_id`, `Shop__Shop_user`.`id` AS `Shop__Shop_user_id`, …(cắt bớt)
```

EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **0.9ms**

Route gọi tới: `GET /api/v1/shop/{sellerId} [buyer]`

</details>

<details><summary><b>dòng 100</b> — <code>Repository.count</code> — <b>[VỪA]</b> đếm cả bảng 2011 dòng cho phân trang <i>(1 lượt, 1.65ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=2011` · `Using where` · chạy thật **1.65ms**

Route gọi tới: `GET /api/v1/shop/{sellerId} [buyer]`

</details>

<details><summary><b>dòng 103</b> — <code>Repository.count</code> <i>(1 lượt, 0.73ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=FK_c518e3988b9c057920afaf2d8c0` · `rows=16` · `Using index` · chạy thật **0.73ms**

Route gọi tới: `GET /api/v1/shop/{sellerId} [buyer]`

</details>

<details><summary><b>dòng 110</b> — <code>Repository.findAndCount</code> — <b>[CAO]</b> TypeORM dựng bảng dẫn xuất rồi DISTINCT trên 2011 dòng <i>(1 lượt, 2.59ms)</i></summary>

```sql
SELECT DISTINCT `distinctAlias`.`Product_id` AS `ids_Product_id`, `distinctAlias`.`Product_created_at` FROM (SELECT `Product`.`id` AS `Product_id`, `Product`.`name` AS `Product_name`, `Product`.`slug` AS `Product_slug`, `Product`.`description` AS `Product_description`, `Product`.`price` AS `Product_price`, `Product`.`currency` AS `Product_currency`, `Product`.`stock` AS `Product_stock`, `Product`.`image` AS `Product_image`, `Product`.`brand` AS `Product_brand`, `Product`.`spec` AS `Product_spec`, `Product`.`images` AS `Product_images`, `Product`.`condition` AS `Product_condition`, `Product`.`is_freeship` AS `Product_is_freeship`, `Product`.`sold_count` AS `Product_sold_count`, `Product`.`view_count` AS `Product_view_count`, `Product`.`status` AS `Product_status`, `Product`.`created_at` AS `Product_created_at`, `Product`.`updated_at` AS `Product_updated_at`, `Product`.`category_id` AS `Pr …(cắt bớt)
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=2011` · `Using where` · chạy thật **2.59ms**

Route gọi tới: `GET /api/v1/shop/{sellerId}/products [buyer]`

</details>

<details><summary><b>dòng 110</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 1.3ms)</i></summary>

```sql
SELECT `Product`.`id` AS `Product_id`, `Product`.`name` AS `Product_name`, `Product`.`slug` AS `Product_slug`, `Product`.`description` AS `Product_description`, `Product`.`price` AS `Product_price`, `Product`.`currency` AS `Product_currency`, `Product`.`stock` AS `Product_stock`, `Product`.`image` AS `Product_image`, `Product`.`brand` AS `Product_brand`, `Product`.`spec` AS `Product_spec`, `Product`.`images` AS `Product_images`, `Product`.`condition` AS `Product_condition`, `Product`.`is_freeship` AS `Product_is_freeship`, `Product`.`sold_count` AS `Product_sold_count`, `Product`.`view_count` AS `Product_view_count`, `Product`.`status` AS `Product_status`, `Product`.`created_at` AS `Product_created_at`, `Product`.`updated_at` AS `Product_updated_at`, `Product`.`category_id` AS `Product_category_id`, `Product`.`seller_id` AS `Product_seller_id`, `Product__Product_category`.`id` AS `Produc …(cắt bớt)
```

EXPLAIN: `type=range` · `key=PRIMARY` · `rows=20` · `Using where` · chạy thật **1.3ms**

Route gọi tới: `GET /api/v1/shop/{sellerId}/products [buyer]`

</details>

<details><summary><b>dòng 110</b> — <code>Repository.findAndCount</code> — <b>[VỪA]</b> đếm cả bảng 2011 dòng cho phân trang <i>(1 lượt, 1.88ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=2011` · `Using where` · chạy thật **1.88ms**

Route gọi tới: `GET /api/v1/shop/{sellerId}/products [buyer]`

</details>

<details><summary><b>dòng 140</b> — <code>Repository.findAndCount</code> — <b>[CAO]</b>  <i>(1 lượt, 6.8ms)</i></summary>
...
EXPLAIN: `type=range` · `key=idx_seller_status` · `rows=2015` · `Using index condition; Using where` · chạy thật **6.8ms**

Route gọi tới: `GET /api/v1/shop/{sellerId}/orders [seller]`

</details>

<details><summary><b>dòng 140</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 1.85ms)</i></summary>
...
EXPLAIN: `type=range` · `key=PRIMARY` · `rows=20` · `Using where; Backward index scan` · chạy thật **1.85ms**

Route gọi tới: `GET /api/v1/shop/{sellerId}/orders [seller]`

</details>

<details><summary><b>dòng 140</b> — <code>Repository.findAndCount</code> — <b>[VỪA]</b> đếm cả bảng 2011 dòng cho phân trang <i>(1 lượt, 6.06ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=2011` · `Using where` · chạy thật **6.06ms**
...
3 câu SQL khác nhau · 3 lượt chạy · **1 mức CAO**

<details><summary><b>dòng 65</b> — <code>Repository.find</code> — <b>[CAO]</b> quét toàn bảng 2011 dòng, không dùng index <i>(1 lượt, 5.37ms)</i></summary>

```sql
SELECT `Product`.`id` AS `Product_id`, `Product`.`name` AS `Product_name`, `Product`.`slug` AS `Product_slug`, `Product`.`updated_at` AS `Product_updated_at` FROM `products` `Product` WHERE ( ((`Product`.`status` = ?)) ) AND ( `Product`.`deleted_at` IS NULL )
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=2011` · `Using where` · chạy thật **5.37ms**

Route gọi tới: `GET /sitemap.xml [buyer]`

</details>

<details><summary><b>dòng 86</b> — <code>Repository.find</code> <i>(1 lượt, 0.87ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=9` · `Using where` · chạy thật **0.87ms**

Route gọi tới: `GET /sitemap.xml [buyer]`

</details>

<details><summary><b>dòng 98</b> — <code>Repository.find</code> <i>(1 lượt, 0.89ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=15` · `Using where` · chạy thật **0.89ms**
...
<details><summary><b>dòng 16</b> — <code>Repository.find</code> <i>(1 lượt, 0.81ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=FK_16aac8a9f6f9c1dd6bcb75ec023` · `rows=2` · chạy thật **0.81ms**

Route gọi tới: `GET /api/v1/addresses [buyer]`

</details>

<details><summary><b>dòng 23</b> — <code>Repository.findOne</code> <i>(2 lượt, 0.72ms)</i></summary>
...
EXPLAIN: `type=?` · `key=∅` · `rows=0` · `Impossible WHERE noticed after reading const tables` · chạy thật **0.72ms**

Route gọi tới: `GET /api/v1/addresses/{id} [buyer]`, `GET /api/v1/addresses/{id} [seller]`

</details>

<details><summary><b>dòng 23</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.64ms)</i></summary>
...
<details><summary><b>dòng 75</b> — <code>Repository.findOne</code> <i>(3 lượt, 0.79ms)</i></summary>
...
EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **0.79ms**
...
<details><summary><b>dòng 24</b> — <code>Repository.findOne</code> <i>(67 lượt, 0.91ms)</i></summary>
...
<details><summary><b>dòng 39</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.77ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=63` · `Using where` · chạy thật **0.77ms**

Route gọi tới: `GET /api/v1/users [admin]`

</details>

<details><summary><b>dòng 39</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.65ms)</i></summary>

```sql
SELECT COUNT(1) AS `cnt` FROM `users` `User` WHERE `User`.`deleted_at` IS NULL
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=63` · `Using where` · chạy thật **0.65ms**

Route gọi tới: `GET /api/v1/users [admin]`

</details>

<details><summary><b>dòng 58</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.77ms)</i></summary>

```sql
SELECT `User`.`id` AS `User_id`, `User`.`full_name` AS `User_full_name`, `User`.`email` AS `User_email`, `User`.`phone_number` AS `User_phone_number`, `User`.`role` AS `User_role`, `User`.`avatar` AS `User_avatar`, `User`.`email_verified` AS `User_email_verified`, `User`.`is_locked` AS `User_is_locked`, `User`.`last_seen` AS `User_last_seen`, `User`.`gender` AS `User_gender`, `User`.`token_version` AS `User_token_version`, `User`.`created_at` AS `User_created_at`, `User`.`deleted_at` AS `User_deleted_at` FROM `users` `User` WHERE ( ((`User`.`id` = ?)) ) AND ( `User`.`deleted_at` IS NULL ) LIMIT 1
```

EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **0.77ms**

Route gọi tới: `GET /api/v1/users/{id} [admin]`

</details>

<details><summary><b>dòng 104</b> — <code>QueryBuilder.getOne</code> <i>(3 lượt, 1.01ms)</i></summary>
...
EXPLAIN: `type=const` · `key=IDX_97672ac88f789774dd47f7c8be` · `rows=1` · chạy thật **1.01ms**
...
<details><summary><b>dòng 106</b> — <code>Repository.findAndCount</code> — <b>[THẤP]</b> sắp xếp ngoài index (filesort); phải dựng bảng tạm <i>(1 lượt, 1.09ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=120` · `Using temporary; Using filesort` · chạy thật **1.09ms**

Route gọi tới: `GET /api/v1/chat/conversations [buyer]`

</details>

<details><summary><b>dòng 106</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 1.34ms)</i></summary>
...
EXPLAIN: `type=range` · `key=PRIMARY` · `rows=3` · `Using where; Using filesort` · chạy thật **1.34ms**

Route gọi tới: `GET /api/v1/chat/conversations [buyer]`

</details>

<details><summary><b>dòng 182</b> — <code>QueryBuilder.getRawMany</code> — <b>[THẤP]</b> sắp xếp ngoài index (filesort) <i>(1 lượt, 0.97ms)</i></summary>
...
EXPLAIN: `type=range` · `key=idx_conversation_created` · `rows=90` · `Using index condition; Using filesort` · chạy thật **0.97ms**

Route gọi tới: `GET /api/v1/chat/conversations [buyer]`

</details>

<details><summary><b>dòng 211</b> — <code>QueryBuilder.getRawMany</code> <i>(1 lượt, 0.99ms)</i></summary>
...
EXPLAIN: `type=range` · `key=idx_conversation_created` · `rows=90` · `Using index condition; Using where` · chạy thật **0.99ms**

Route gọi tới: `GET /api/v1/chat/conversations [buyer]`

</details>

<details><summary><b>dòng 224</b> — <code>Repository.findOne</code> <i>(2 lượt, 0.81ms)</i></summary>

```sql
SELECT DISTINCT `distinctAlias`.`Conversation_id` AS `ids_Conversation_id` FROM (SELECT `Conversation`.`id` AS `Conversation_id`, `Conversation`.`created_at` AS `Conversation_created_at`, `Conversation`.`updated_at` AS `Conversation_updated_at`, `Conversation`.`buyer_id` AS `Conversation_buyer_id`, `Conversation`.`seller_id` AS `Conversation_seller_id`, `Conversation`.`product_id` AS `Conversation_product_id`, `Conversation__Conversation_buyer`.`id` AS `Conversation__Conversation_buyer_id`, `Conversation__Conversation_buyer`.`full_name` AS `Conversation__Conversation_buyer_full_name`, `Conversation__Conversation_buyer`.`email` AS `Conversation__Conversation_buyer_email`, `Conversation__Conversation_buyer`.`phone_number` AS `Conversation__Conversation_buyer_phone_number`, `Conversation__Conversation_buyer`.`role` AS `Conversation__Conversation_buyer_role`, `Conversation__Conversation_buye …(cắt bớt)
```

EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **0.81ms**

Route gọi tới: `GET /api/v1/chat/conversations/{id}/messages [buyer]`, `GET /api/v1/chat/conversations/{id}/messages [seller]`

</details>

<details><summary><b>dòng 224</b> — <code>Repository.findOne</code> <i>(2 lượt, 1.07ms)</i></summary>

```sql
SELECT `Conversation`.`id` AS `Conversation_id`, `Conversation`.`created_at` AS `Conversation_created_at`, `Conversation`.`updated_at` AS `Conversation_updated_at`, `Conversation`.`buyer_id` AS `Conversation_buyer_id`, `Conversation`.`seller_id` AS `Conversation_seller_id`, `Conversation`.`product_id` AS `Conversation_product_id`, `Conversation__Conversation_buyer`.`id` AS `Conversation__Conversation_buyer_id`, `Conversation__Conversation_buyer`.`full_name` AS `Conversation__Conversation_buyer_full_name`, `Conversation__Conversation_buyer`.`email` AS `Conversation__Conversation_buyer_email`, `Conversation__Conversation_buyer`.`phone_number` AS `Conversation__Conversation_buyer_phone_number`, `Conversation__Conversation_buyer`.`role` AS `Conversation__Conversation_buyer_role`, `Conversation__Conversation_buyer`.`avatar` AS `Conversation__Conversation_buyer_avatar`, `Conversation__Conversa …(cắt bớt)
```

EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **1.07ms**

Route gọi tới: `GET /api/v1/chat/conversations/{id}/messages [buyer]`, `GET /api/v1/chat/conversations/{id}/messages [seller]`

</details>

<details><summary><b>dòng 250</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.99ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=idx_conversation_created` · `rows=30` · chạy thật **0.99ms**

Route gọi tới: `GET /api/v1/chat/conversations/{id}/messages [seller]`

</details>

<details><summary><b>dòng 250</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 1.16ms)</i></summary>
...
EXPLAIN: `type=range` · `key=PRIMARY` · `rows=20` · `Using where` · chạy thật **1.16ms**

Route gọi tới: `GET /api/v1/chat/conversations/{id}/messages [seller]`

</details>

<details><summary><b>dòng 250</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.69ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=idx_conversation_created` · `rows=30` · chạy thật **0.69ms**

Route gọi tới: `GET /api/v1/chat/conversations/{id}/messages [seller]`

</details>

<details><summary><b>dòng 354</b> — <code>QueryBuilder.getCount</code> <i>(1 lượt, 0.91ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=idx_conversation_created` · `rows=30` · `Using where` · chạy thật **0.91ms**
...
<details><summary><b>dòng 38</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.92ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=idx_user_created` · `rows=25` · `Using index` · chạy thật **0.92ms**

Route gọi tới: `GET /api/v1/notifications [buyer]`

</details>

<details><summary><b>dòng 38</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 1.13ms)</i></summary>
...
EXPLAIN: `type=range` · `key=PRIMARY` · `rows=10` · `Using where` · chạy thật **1.13ms**

Route gọi tới: `GET /api/v1/notifications [buyer]`

</details>

<details><summary><b>dòng 38</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.69ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=idx_user_read` · `rows=25` · `Using index` · chạy thật **0.69ms**

Route gọi tới: `GET /api/v1/notifications [buyer]`

</details>

<details><summary><b>dòng 59</b> — <code>Repository.count</code> <i>(1 lượt, 0.63ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=idx_user_read` · `rows=8` · `Using index` · chạy thật **0.63ms**

Route gọi tới: `GET /api/v1/notifications/unread-count [buyer]`

</details>

<details><summary><b>dòng 66</b> — <code>Repository.findOne</code> <i>(2 lượt, 0.67ms)</i></summary>
...
EXPLAIN: `type=?` · `key=∅` · `rows=0` · `Impossible WHERE noticed after reading const tables` · chạy thật **0.67ms**

Route gọi tới: `GET /api/v1/notifications/{id} [buyer]`, `GET /api/v1/notifications/{id} [seller]`

</details>

<details><summary><b>dòng 66</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.62ms)</i></summary>
...
EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **0.62ms**
...
<details><summary><b>dòng 246</b> — <code>Repository.find</code> <i>(1 lượt, 1.07ms)</i></summary>
...
<details><summary><b>dòng 261</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.99ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=idx_seller` · `rows=2` · chạy thật **0.99ms**

Route gọi tới: `GET /api/v1/escrows/seller/{sellerId} [buyer]`

</details>

<details><summary><b>dòng 261</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 1.63ms)</i></summary>

```sql
SELECT `Escrow`.`id` AS `Escrow_id`, `Escrow`.`amount` AS `Escrow_amount`, `Escrow`.`status` AS `Escrow_status`, `Escrow`.`released_at` AS `Escrow_released_at`, `Escrow`.`note` AS `Escrow_note`, `Escrow`.`created_at` AS `Escrow_created_at`, `Escrow`.`updated_at` AS `Escrow_updated_at`, `Escrow`.`order_id` AS `Escrow_order_id`, `Escrow`.`buyer_id` AS `Escrow_buyer_id`, `Escrow`.`seller_id` AS `Escrow_seller_id`, `Escrow__Escrow_order`.`id` AS `Escrow__Escrow_order_id`, `Escrow__Escrow_order`.`order_code` AS `Escrow__Escrow_order_order_code`, `Escrow__Escrow_order`.`total_amount` AS `Escrow__Escrow_order_total_amount`, `Escrow__Escrow_order`.`shipping_fee` AS `Escrow__Escrow_order_shipping_fee`, `Escrow__Escrow_order`.`discount_amount` AS `Escrow__Escrow_order_discount_amount`, `Escrow__Escrow_order`.`final_amount` AS `Escrow__Escrow_order_final_amount`, `Escrow__Escrow_order`.`currency` A …(cắt bớt)
```

EXPLAIN: `type=range` · `key=PRIMARY` · `rows=2` · `Using where` · chạy thật **1.63ms**

Route gọi tới: `GET /api/v1/escrows/seller/{sellerId} [buyer]`

</details>

<details><summary><b>dòng 284</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 1.03ms)</i></summary>

```sql
SELECT DISTINCT `distinctAlias`.`Escrow_id` AS `ids_Escrow_id`, `distinctAlias`.`Escrow_created_at` FROM (SELECT `Escrow`.`id` AS `Escrow_id`, `Escrow`.`amount` AS `Escrow_amount`, `Escrow`.`status` AS `Escrow_status`, `Escrow`.`released_at` AS `Escrow_released_at`, `Escrow`.`note` AS `Escrow_note`, `Escrow`.`created_at` AS `Escrow_created_at`, `Escrow`.`updated_at` AS `Escrow_updated_at`, `Escrow`.`order_id` AS `Escrow_order_id`, `Escrow`.`buyer_id` AS `Escrow_buyer_id`, `Escrow`.`seller_id` AS `Escrow_seller_id`, `Escrow__Escrow_order`.`id` AS `Escrow__Escrow_order_id`, `Escrow__Escrow_order`.`order_code` AS `Escrow__Escrow_order_order_code`, `Escrow__Escrow_order`.`total_amount` AS `Escrow__Escrow_order_total_amount`, `Escrow__Escrow_order`.`shipping_fee` AS `Escrow__Escrow_order_shipping_fee`, `Escrow__Escrow_order`.`discount_amount` AS `Escrow__Escrow_order_discount_amount`, `Escrow …(cắt bớt)
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=2` · `Using temporary; Using filesort` · chạy thật **1.03ms**

Route gọi tới: `GET /api/v1/escrows [buyer]`

</details>

<details><summary><b>dòng 284</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 1.05ms)</i></summary>

```sql
SELECT `Escrow`.`id` AS `Escrow_id`, `Escrow`.`amount` AS `Escrow_amount`, `Escrow`.`status` AS `Escrow_status`, `Escrow`.`released_at` AS `Escrow_released_at`, `Escrow`.`note` AS `Escrow_note`, `Escrow`.`created_at` AS `Escrow_created_at`, `Escrow`.`updated_at` AS `Escrow_updated_at`, `Escrow`.`order_id` AS `Escrow_order_id`, `Escrow`.`buyer_id` AS `Escrow_buyer_id`, `Escrow`.`seller_id` AS `Escrow_seller_id`, `Escrow__Escrow_order`.`id` AS `Escrow__Escrow_order_id`, `Escrow__Escrow_order`.`order_code` AS `Escrow__Escrow_order_order_code`, `Escrow__Escrow_order`.`total_amount` AS `Escrow__Escrow_order_total_amount`, `Escrow__Escrow_order`.`shipping_fee` AS `Escrow__Escrow_order_shipping_fee`, `Escrow__Escrow_order`.`discount_amount` AS `Escrow__Escrow_order_discount_amount`, `Escrow__Escrow_order`.`final_amount` AS `Escrow__Escrow_order_final_amount`, `Escrow__Escrow_order`.`currency` A …(cắt bớt)
```

EXPLAIN: `type=range` · `key=PRIMARY` · `rows=2` · `Using where; Using filesort` · chạy thật **1.05ms**

Route gọi tới: `GET /api/v1/escrows [buyer]`

</details>

<details><summary><b>dòng 309</b> — <code>QueryBuilder.getRawOne</code> <i>(1 lượt, 0.75ms)</i></summary>

```sql
SELECT COALESCE(SUM(`escrow`.`amount`), 0) AS `total` FROM `escrows` `escrow` WHERE `escrow`.`seller_id` = ? AND `escrow`.`status` = ?
```

EXPLAIN: `type=ref` · `key=idx_seller` · `rows=2` · `Using where` · chạy thật **0.75ms**
...
<details><summary><b>dòng 74</b> — <code>EntityManager.findOne</code> <i>(1 lượt, 0.63ms)</i></summary>
...
EXPLAIN: `type=const` · `key=uq_ledger_account` · `rows=1` · chạy thật **0.63ms**

Route gọi tới: `GET /api/v1/wallets/transactions [buyer]`

</details>

<details><summary><b>dòng 232</b> — <code>EntityManager.findOne</code> <i>(4 lượt, 0.84ms)</i></summary>

```sql
SELECT `LedgerAccount`.`id` AS `LedgerAccount_id`, `LedgerAccount`.`owner_type` AS `LedgerAccount_owner_type`, `LedgerAccount`.`owner_id` AS `LedgerAccount_owner_id`, `LedgerAccount`.`purpose` AS `LedgerAccount_purpose`, `LedgerAccount`.`balance` AS `LedgerAccount_balance`, `LedgerAccount`.`version` AS `LedgerAccount_version`, `LedgerAccount`.`created_at` AS `LedgerAccount_created_at`, `LedgerAccount`.`updated_at` AS `LedgerAccount_updated_at` FROM `ledger_accounts` `LedgerAccount` WHERE ((`LedgerAccount`.`owner_type` = ?) AND (`LedgerAccount`.`owner_id` = ?) AND (`LedgerAccount`.`purpose` = ?)) LIMIT 1
```

EXPLAIN: `type=const` · `key=uq_ledger_account` · `rows=1` · chạy thật **0.84ms**
...
<details><summary><b>dòng 164</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.92ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=idx_user_id` · `rows=15` · chạy thật **0.92ms**

Route gọi tới: `GET /api/v1/payments [buyer]`

</details>

<details><summary><b>dòng 164</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 1.86ms)</i></summary>
...
EXPLAIN: `type=range` · `key=PRIMARY` · `rows=10` · `Using where` · chạy thật **1.86ms**

Route gọi tới: `GET /api/v1/payments [buyer]`

</details>

<details><summary><b>dòng 164</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.71ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=idx_user_id` · `rows=15` · chạy thật **0.71ms**

Route gọi tới: `GET /api/v1/payments [buyer]`

</details>

<details><summary><b>dòng 189</b> — <code>Repository.findOne</code> <i>(2 lượt, 0.85ms)</i></summary>
...
EXPLAIN: `type=?` · `key=∅` · `rows=0` · `Impossible WHERE noticed after reading const tables` · chạy thật **0.85ms**

Route gọi tới: `GET /api/v1/payments/{id} [buyer]`, `GET /api/v1/payments/{id} [seller]`

</details>

<details><summary><b>dòng 189</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.71ms)</i></summary>

```sql
SELECT DISTINCT `distinctAlias`.`Payment_id` AS `ids_Payment_id` FROM (SELECT `Payment`.`id` AS `Payment_id`, `Payment`.`amount` AS `Payment_amount`, `Payment`.`payment_method` AS `Payment_payment_method`, `Payment`.`transaction_code` AS `Payment_transaction_code`, `Payment`.`status` AS `Payment_status`, `Payment`.`type` AS `Payment_type`, `Payment`.`note` AS `Payment_note`, `Payment`.`paid_at` AS `Payment_paid_at`, `Payment`.`payos_order_code` AS `Payment_payos_order_code`, `Payment`.`payos_payment_link_id` AS `Payment_payos_payment_link_id`, `Payment`.`payos_checkout_url` AS `Payment_payos_checkout_url`, `Payment`.`payos_qr_code` AS `Payment_payos_qr_code`, `Payment`.`created_at` AS `Payment_created_at`, `Payment`.`updated_at` AS `Payment_updated_at`, `Payment`.`order_id` AS `Payment_order_id`, `Payment`.`user_id` AS `Payment_user_id`, `Payment__Payment_order`.`id` AS `Payment__Payment …(cắt bớt)
```

EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **0.71ms**

Route gọi tới: `GET /api/v1/payments/{id} [admin]`

</details>

<details><summary><b>dòng 189</b> — <code>Repository.findOne</code> <i>(1 lượt, 1.06ms)</i></summary>
...
<details><summary><b>dòng 193</b> — <code>Repository.findOne</code> <i>(1 lượt, 1.07ms)</i></summary>
...
<details><summary><b>dòng 199</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.76ms)</i></summary>

```sql
SELECT DISTINCT `distinctAlias`.`Payment_id` AS `ids_Payment_id`, `distinctAlias`.`Payment_created_at` FROM (SELECT `Payment`.`id` AS `Payment_id`, `Payment`.`amount` AS `Payment_amount`, `Payment`.`payment_method` AS `Payment_payment_method`, `Payment`.`transaction_code` AS `Payment_transaction_code`, `Payment`.`status` AS `Payment_status`, `Payment`.`type` AS `Payment_type`, `Payment`.`note` AS `Payment_note`, `Payment`.`paid_at` AS `Payment_paid_at`, `Payment`.`payos_order_code` AS `Payment_payos_order_code`, `Payment`.`payos_payment_link_id` AS `Payment_payos_payment_link_id`, `Payment`.`payos_checkout_url` AS `Payment_payos_checkout_url`, `Payment`.`payos_qr_code` AS `Payment_payos_qr_code`, `Payment`.`created_at` AS `Payment_created_at`, `Payment`.`updated_at` AS `Payment_updated_at`, `Payment`.`order_id` AS `Payment_order_id`, `Payment`.`user_id` AS `Payment_user_id` FROM `payment …(cắt bớt)
```

EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · `Using temporary; Using filesort` · chạy thật **0.76ms**
...
<details><summary><b>dòng 244</b> — <code>EntityManager.query</code> <i>(1 lượt, 0.69ms)</i></summary>

```sql
SELECT COUNT(*) AS total FROM ledger_entries e JOIN ledger_transactions t ON t.id = e.transaction_id WHERE e.account_id = ?
```

EXPLAIN: `type=ref` · `key=idx_ledger_entry_account_time` · `rows=1` · `Using index condition; Using where` · chạy thật **0.69ms**

Route gọi tới: `GET /api/v1/wallets/transactions [buyer]`

</details>

<details><summary><b>dòng 251</b> — <code>EntityManager.query</code> <i>(1 lượt, 0.72ms)</i></summary>
...
EXPLAIN: `type=ref` · `key=idx_ledger_entry_account_time` · `rows=1` · `Using index condition; Using where; Using filesort` · chạy thật **0.72ms**
...
<details><summary><b>dòng 119</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.7ms)</i></summary>
...
EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · `Using temporary; Using filesort` · chạy thật **0.7ms**
...
<details><summary><b>dòng 47</b> — <code>Repository.findAndCount</code> — <b>[THẤP]</b> sắp xếp ngoài index (filesort) <i>(1 lượt, 0.83ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=63` · `Using where; Using filesort` · chạy thật **0.83ms**

Route gọi tới: `GET /api/v1/admin/users [admin]`

</details>

<details><summary><b>dòng 47</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 0.69ms)</i></summary>

```sql
SELECT COUNT(1) AS `cnt` FROM `users` `User` WHERE `User`.`deleted_at` IS NULL
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=63` · `Using where` · chạy thật **0.69ms**

Route gọi tới: `GET /api/v1/admin/users [admin]`

</details>

<details><summary><b>dòng 66</b> — <code>Repository.findOne</code> <i>(1 lượt, 0.63ms)</i></summary>
...
<details><summary><b>dòng 70</b> — <code>Repository.count</code> <i>(1 lượt, 0.66ms)</i></summary>
...
EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **0.66ms**

Route gọi tới: `GET /api/v1/admin/users/{id} [admin]`

</details>

<details><summary><b>dòng 71</b> — <code>Repository.count</code> — <b>[VỪA]</b> đếm cả bảng 2011 dòng cho phân trang <i>(1 lượt, 1.31ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=2011` · `Using where` · chạy thật **1.31ms**

Route gọi tới: `GET /api/v1/admin/users/{id} [admin]`

</details>

<details><summary><b>dòng 130</b> — <code>Repository.count</code> <i>(1 lượt, 0.88ms)</i></summary>

```sql
SELECT COUNT(1) AS `cnt` FROM `users` `User` WHERE `User`.`deleted_at` IS NULL
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=63` · `Using where` · chạy thật **0.88ms**

Route gọi tới: `GET /api/v1/admin/stats [admin]`

</details>

<details><summary><b>dòng 131</b> — <code>Repository.count</code> — <b>[VỪA]</b> đếm cả bảng 2011 dòng cho phân trang <i>(1 lượt, 1ms)</i></summary>

```sql
SELECT COUNT(1) AS `cnt` FROM `products` `Product` WHERE `Product`.`deleted_at` IS NULL
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=2011` · `Using where` · chạy thật **1ms**

Route gọi tới: `GET /api/v1/admin/stats [admin]`

</details>

<details><summary><b>dòng 132</b> — <code>Repository.count</code> — <b>[VỪA]</b> đếm cả bảng 1003 dòng cho phân trang <i>(1 lượt, 0.7ms)</i></summary>

```sql
SELECT COUNT(1) AS `cnt` FROM `orders` `Order` WHERE `Order`.`deleted_at` IS NULL
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=1003` · `Using where` · chạy thật **0.7ms**

Route gọi tới: `GET /api/v1/admin/stats [admin]`

</details>

<details><summary><b>dòng 137</b> — <code>QueryBuilder.getRawOne</code> — <b>[CAO]</b> quét toàn bảng 1003 dòng, không dùng index <i>(1 lượt, 1.07ms)</i></summary>

```sql
SELECT COALESCE(SUM(`order`.`final_amount`), 0) AS `total` FROM `orders` `order` WHERE ( `order`.`status` = ? ) AND ( `order`.`deleted_at` IS NULL )
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=1003` · `Using where` · chạy thật **1.07ms**

Route gọi tới: `GET /api/v1/admin/stats [admin]`

</details>

<details><summary><b>dòng 140</b> — <code>Repository.count</code> — <b>[VỪA]</b> đếm cả bảng 1003 dòng cho phân trang <i>(1 lượt, 0.82ms)</i></summary>

```sql
SELECT COUNT(1) AS `cnt` FROM `orders` `Order` WHERE ( ((`Order`.`status` = ?)) ) AND ( `Order`.`deleted_at` IS NULL )
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=1003` · `Using where` · chạy thật **0.82ms**

Route gọi tới: `GET /api/v1/admin/stats [admin]`

</details>

<details><summary><b>dòng 156</b> — <code>Repository.find</code> <i>(1 lượt, 0.69ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=1` · chạy thật **0.69ms**

Route gọi tới: `GET /api/v1/admin/settings [admin]`

</details>

<details><summary><b>dòng 180</b> — <code>Repository.findAndCount</code> — <b>[VỪA]</b> TypeORM dựng bảng dẫn xuất rồi DISTINCT trên 315 dòng; sắp xếp ngoài index (filesort); phải dựng bảng tạm <i>(1 lượt, 1.01ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=315` · `Using temporary; Using filesort` · chạy thật **1.01ms**

Route gọi tới: `GET /api/v1/admin/withdrawals [admin]`

</details>

<details><summary><b>dòng 180</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 1.38ms)</i></summary>
...
EXPLAIN: `type=range` · `key=PRIMARY` · `rows=20` · `Using where; Using filesort` · chạy thật **1.38ms**

Route gọi tới: `GET /api/v1/admin/withdrawals [admin]`

</details>

<details><summary><b>dòng 180</b> — <code>Repository.findAndCount</code> — <b>[VỪA]</b> đếm cả bảng 315 dòng cho phân trang <i>(1 lượt, 0.73ms)</i></summary>
...
EXPLAIN: `type=ALL` · `key=∅` · `rows=315` · chạy thật **0.73ms**
...
<details><summary><b>dòng 16</b> — <code>Repository.find</code> <i>(1 lượt, 0.57ms)</i></summary>

```sql
SELECT `Setting`.`id` AS `Setting_id`, `Setting`.`key` AS `Setting_key`, `Setting`.`value` AS `Setting_value`, `Setting`.`created_at` AS `Setting_created_at`, `Setting`.`updated_at` AS `Setting_updated_at` FROM `settings` `Setting`
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=1` · chạy thật **0.57ms**

Route gọi tới: `GET /api/v1/settings [admin]`

</details>

<details><summary><b>dòng 31</b> — <code>Repository.find</code> <i>(1 lượt, 0.62ms)</i></summary>
...
EXPLAIN: `type=range` · `key=IDX_c8639b7626fa94ba8265628f21` · `rows=4` · `Using index condition` · chạy thật **0.62ms**

Route gọi tới: `GET /api/v1/settings/public [buyer]`

</details>

<details><summary><b>dòng 47</b> — <code>Repository.findOne</code> <i>(2 lượt, 0.73ms)</i></summary>
...
EXPLAIN: `type=?` · `key=∅` · `rows=0` · `no matching row in const table` · chạy thật **0.73ms**

Route gọi tới: `GET / [buyer]`, `GET /api/v1/admin/stats [seller]`
...
<details><summary><b>dòng 44</b> — <code>Repository.findAndCount</code> <i>(1 lượt, 1.06ms)</i></summary>
...
<details><summary><b>dòng 61</b> — <code>Repository.findOne</code> <i>(3 lượt, 0.94ms)</i></summary>
...
EXPLAIN: `type=?` · `key=∅` · `rows=0` · `no matching row in const table` · chạy thật **0.94ms**
...
<details><summary><b>dòng 72</b> — <code>Repository.count</code> <i>(1 lượt, 0.77ms)</i></summary>
...
<details><summary><b>dòng 73</b> — <code>Repository.count</code> — <b>[VỪA]</b> đếm cả bảng 2011 dòng cho phân trang <i>(1 lượt, 1.02ms)</i></summary>

```sql
SELECT COUNT(1) AS `cnt` FROM `products` `Product` WHERE `Product`.`deleted_at` IS NULL
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=2011` · `Using where` · chạy thật **1.02ms**

Route gọi tới: `GET /api/v1/orders/stats [admin]`

</details>

<details><summary><b>dòng 74</b> — <code>Repository.count</code> — <b>[VỪA]</b> đếm cả bảng 1003 dòng cho phân trang <i>(1 lượt, 0.73ms)</i></summary>

```sql
SELECT COUNT(1) AS `cnt` FROM `orders` `Order` WHERE `Order`.`deleted_at` IS NULL
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=1003` · `Using where` · chạy thật **0.73ms**

Route gọi tới: `GET /api/v1/orders/stats [admin]`

</details>

<details><summary><b>dòng 80</b> — <code>QueryBuilder.getRawOne</code> — <b>[CAO]</b> quét toàn bảng 1003 dòng, không dùng index <i>(1 lượt, 0.91ms)</i></summary>

```sql
SELECT COALESCE(SUM(`order`.`final_amount`), 0) AS `total` FROM `orders` `order` WHERE ( `order`.`status` != ? ) AND ( `order`.`deleted_at` IS NULL )
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=1003` · `Using where` · chạy thật **0.91ms**

Route gọi tới: `GET /api/v1/orders/stats [admin]`

</details>

<details><summary><b>dòng 323</b> — <code>QueryBuilder.getCount</code> — <b>[VỪA]</b> đếm cả bảng 1003 dòng cho phân trang <i>(1 lượt, 1.01ms)</i></summary>

```sql
SELECT COUNT(1) AS `cnt` FROM `orders` `order` WHERE ( `order`.`user_id` = ? ) AND ( `order`.`deleted_at` IS NULL )
```

EXPLAIN: `type=ALL` · `key=∅` · `rows=1003` · `Using where` · chạy thật **1.01ms**

Route gọi tới: `GET /api/v1/orders [buyer]`

</details>

<details><summary><b>dòng 361</b> — <code>QueryBuilder.getRawMany</code> — <b>[CAO]</b>  <i>(1 lượt, 0.73ms)</i></summary>
...
EXPLAIN: `type=range` · `key=idx_user_created` · `rows=1003` · `Using index condition; Using where; Backward index scan` · chạy thật **0.73ms**

Route gọi tới: `GET /api/v1/orders [buyer]`

</details>

<details><summary><b>dòng 367</b> — <code>Repository.find</code> <i>(1 lượt, 1.82ms)</i></summary>

```sql
SELECT `Order`.`id` AS `Order_id`, `Order`.`order_code` AS `Order_order_code`, `Order`.`total_amount` AS `Order_total_amount`, `Order`.`shipping_fee` AS `Order_shipping_fee`, `Order`.`discount_amount` AS `Order_discount_amount`, `Order`.`final_amount` AS `Order_final_amount`, `Order`.`currency` AS `Order_currency`, `Order`.`status` AS `Order_status`, `Order`.`payment_method` AS `Order_payment_method`, `Order`.`is_paid` AS `Order_is_paid`, `Order`.`paid_at` AS `Order_paid_at`, `Order`.`receiver_name` AS `Order_receiver_name`, `Order`.`receiver_phone` AS `Order_receiver_phone`, `Order`.`shipping_address` AS `Order_shipping_address`, `Order`.`province` AS `Order_province`, `Order`.`district` AS `Order_district`, `Order`.`ghn_district_id` AS `Order_ghn_district_id`, `Order`.`ghn_ward_code` AS `Order_ghn_ward_code`, `Order`.`note` AS `Order_note`, `Order`.`tracking_code` AS `Order_tracking_co …(cắt bớt)
```

EXPLAIN: `type=range` · `key=PRIMARY` · `rows=10` · `Using where; Using filesort` · chạy thật **1.82ms**

Route gọi tới: `GET /api/v1/orders [buyer]`

</details>

<details><summary><b>dòng 402</b> — <code>Repository.findOne</code> <i>(1 lượt, 1.09ms)</i></summary>

```sql
SELECT DISTINCT `distinctAlias`.`Order_id` AS `ids_Order_id` FROM (SELECT `Order`.`id` AS `Order_id`, `Order`.`order_code` AS `Order_order_code`, `Order`.`total_amount` AS `Order_total_amount`, `Order`.`shipping_fee` AS `Order_shipping_fee`, `Order`.`discount_amount` AS `Order_discount_amount`, `Order`.`final_amount` AS `Order_final_amount`, `Order`.`currency` AS `Order_currency`, `Order`.`status` AS `Order_status`, `Order`.`payment_method` AS `Order_payment_method`, `Order`.`is_paid` AS `Order_is_paid`, `Order`.`paid_at` AS `Order_paid_at`, `Order`.`receiver_name` AS `Order_receiver_name`, `Order`.`receiver_phone` AS `Order_receiver_phone`, `Order`.`shipping_address` AS `Order_shipping_address`, `Order`.`province` AS `Order_province`, `Order`.`district` AS `Order_district`, `Order`.`ghn_district_id` AS `Order_ghn_district_id`, `Order`.`ghn_ward_code` AS `Order_ghn_ward_code`, `Order`.`n …(cắt bớt)
```

EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · `Using temporary` · chạy thật **1.09ms**

Route gọi tới: `GET /api/v1/orders/{id} [buyer]`

</details>

<details><summary><b>dòng 402</b> — <code>Repository.findOne</code> <i>(1 lượt, 1.27ms)</i></summary>

```sql
SELECT `Order`.`id` AS `Order_id`, `Order`.`order_code` AS `Order_order_code`, `Order`.`total_amount` AS `Order_total_amount`, `Order`.`shipping_fee` AS `Order_shipping_fee`, `Order`.`discount_amount` AS `Order_discount_amount`, `Order`.`final_amount` AS `Order_final_amount`, `Order`.`currency` AS `Order_currency`, `Order`.`status` AS `Order_status`, `Order`.`payment_method` AS `Order_payment_method`, `Order`.`is_paid` AS `Order_is_paid`, `Order`.`paid_at` AS `Order_paid_at`, `Order`.`receiver_name` AS `Order_receiver_name`, `Order`.`receiver_phone` AS `Order_receiver_phone`, `Order`.`shipping_address` AS `Order_shipping_address`, `Order`.`province` AS `Order_province`, `Order`.`district` AS `Order_district`, `Order`.`ghn_district_id` AS `Order_ghn_district_id`, `Order`.`ghn_ward_code` AS `Order_ghn_ward_code`, `Order`.`note` AS `Order_note`, `Order`.`tracking_code` AS `Order_tracking_co …(cắt bớt)
```

EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **1.27ms**

Route gọi tới: `GET /api/v1/orders/{id} [buyer]`

</details>

<details><summary><b>dòng 414</b> — <code>Repository.find</code> <i>(1 lượt, 0.98ms)</i></summary>
...
EXPLAIN: `type=const` · `key=PRIMARY` · `rows=1` · chạy thật **0.98ms**
